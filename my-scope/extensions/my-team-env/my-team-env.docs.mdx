...
We have called this the `my-team-env` component as it adds a more concrete config via overriding the webpack and ts configs
...
for `stylable css` for components which use this as their env.
